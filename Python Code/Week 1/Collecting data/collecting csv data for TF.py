...
Note:
    ...
    Essential data: imu_angle and encoder ticks
...
def data_to_list(listToSave):
    ...
    # SAVE ESSENTIAL
    tempList = [tb.get_encoder_thicks(), tb.get_imu_angle(), timeDif]
    
    listToSave.append(tempList)
    return listToSave, timeDif
    
def data_to_csv(listToSave):
    name = "Saved data angular"+ ".csv" # change name according to recording type
